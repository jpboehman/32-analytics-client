      ...
      >
        <Row>
          ...
          >
            ...
            <Typography.Text>
              ...
              scale of 0-100 through the use of traditional and advanced
              statistics.
            </Typography.Text>
            <br />
            <br />
            <Button
              ...
              `}
              type='link'
              href='/ncaa-player-season-grades-eps'
            >
              NCAA
            </Button>
            <Button
              ...
              `}
              type='link'
              href='/nba-player-season-grades-eps'
            >
              NBA
            </Button>
          </Card>
          ...
          <Card
            title='Efficient Production Score'
            className={css`
              width: 25%;
            `}
          >
            ...
            <Divider />
            <Typography.Text>
              Efficient Production Score attempts to measure a player’s
              performance by applying linear weights to traditional box score
              statistics.
            </Typography.Text>
            <br />
            <br />
          ...
          <Card
            title='Efficient Production Score Spread'
            className={css`
              width: 25%;
            `}
          >
            ...
            <Divider />
            <Typography.Text>
              EPSS is used to measure team performance by finding the
          ...
          >
            ...
            <Divider />
            <Typography.Text>
              Expected Wins offers an expected win total through games played
              and expected win percentage for each team based on our EPS
              statistic.
            </Typography.Text>
            <br />
            <br />
        ...
        <Row>
          ...
          >
            ...
            <br />
            <Typography.Text>
              In 9 of the past 10 seasons, the NBA MVP has finished within the
              top 2 of Player Grades for that season
            </Typography.Text>
            <br />
            <br />
            ...
            <br />
            <Typography.Text>
              In 7 of the past 10 seasons, the AP Player of the Year has
              finished in the top 3 of Player Grades for that season
            </Typography.Text>
          </Card>
          ...
          >
            ...
            <br />
            <Typography.Text>
              Nikola Jokić, the 2020-2021 NBA MVP, led the league in EPS last
              season
            </Typography.Text>
            <br />
            <br />
            ...
            <br />
            <Typography.Text>
              Luka Garza, the 2020-2021 AP National Player of the Year, led the
              country in EPS last season
            </Typography.Text>
          </Card>
          <Card
            title='Stat Accuracy'
          ...
          >
            ...
            <br />
            <Typography.Text>
              EPSS is strongly correlated (0.93) with winning percentage in the
              NBA
            </Typography.Text>
            <br />
            <br />
            ...
            <br />
            <Typography.Text>
              EPSS is strongly correlated (0.89) with winning percentage in the
              NCAA
            </Typography.Text>
          </Card>
          <Card
